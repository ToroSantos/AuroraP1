    ...
    def _generar_con_aurora(self, params: Dict[str, Any], 
        ...
        try:
            ...
            if audio_data is None:
                ...
                if hasattr(audio_data, 'exito') and not audio_data.get('exito', False):
                    actual_audio = None
            else:
                actual_audio = audio_data

            if actual_audio is None or (hasattr(actual_audio, 'size') and actual_audio.size == 0):
