...
try:
    ...
    if hasattr(neuromix_definitivo_v7, 'NeuroMixSuperUnificado'):
        ...
        AuroraNeuroMixV7 = AuroraNeuroAcousticEngineV27Connected
        NeuroMix = AuroraNeuroAcousticEngineV27Connected
        
        # Crear instancia global con la clase Connected
        _global_engine = AuroraNeuroAcousticEngineV27Connected()
