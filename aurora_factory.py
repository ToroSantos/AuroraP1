...
class AuroraComponentFactory:
    ...
    def _auto_registrar_componentes_aurora(self):
        ...
        # Motores principales
        motores = [
            ("neuromix_aurora_v27", "NeuroMixAuroraV27", "neuromix_aurora_v27"),
            ("neuromix_definitivo_v7", "NeuroMixSuperUnificado", "neuromix_definitivo_v7"),
            ("harmonicEssence_v34", "HarmonicEssenceV34", "harmonicEssence_v34"),
            ("hypermod_v32", "HyperModV32", "hypermod_v32")
        ]
