...
class NeuroMixSuperUnificadoRefactored(ComponenteAuroraBase):
    ...
    def _amplificar_neuroacusticamente(self, audio_data, configuracion):
            # 🔄 SWITCH TEMPORAL: Desactivar para usar sistema integrado
            USAR_SISTEMA_INTEGRADO = True
            if USAR_SISTEMA_INTEGRADO:
                logger.info("🔄 Sistema neuroacústico integrado activo - saltando post-procesamiento")
                return audio_data
